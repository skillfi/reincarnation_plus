...
public class ReiJeiPlugin implements IModPlugin {
    ...
    static final RecipeType<InfuserEvolvingRecipe> INFUSER_EVOLVING;
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        ...
        registration.addRecipeCategories(new InfusionEvolveRecipeCategory(registration.getJeiHelpers().getGuiHelper()));
    }
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(ReiItems.MAGIC_INFUSER.get().getDefaultInstance(), new RecipeType[]{INFUSER_EVOLVING});
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(INFUSER_EVOLVING, rm.getAllRecipesFor((net.minecraft.world.item.crafting.RecipeType)ReiRecipeTypes.INFUSER_EVOLVING.get()));
    }
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        ...
        registration.addRecipeClickArea(AutoInfuserScreen.class, 37, 89, 13, 13, new RecipeType[]{MAGIC_INFUSER_MELTING});
        registration.addRecipeClickArea(AutoInfuserScreen.class, 163, 10, 15, 5, new RecipeType[]{MAGIC_INFUSION});
    }
    ...
    static {
        ...
        INFUSER_EVOLVING = new RecipeType(InfusionEvolveRecipeCategory.UID, InfuserEvolvingRecipe.class);
    }
}
