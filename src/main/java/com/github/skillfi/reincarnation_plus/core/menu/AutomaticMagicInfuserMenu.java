...
public class AutomaticMagicInfuserMenu extends AbstractContainerMenu {
    private static final Logger log = LogManager.getLogger(AutomaticMagicInfuserMenu.class);
    ...
    public final AutomaticMagiculaInfuserBlockEntity blockEntity;
    ...
    public AutomaticMagicInfuserMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, (AutomaticMagiculaInfuserBlockEntity)inv.player.level.getBlockEntity(extraData.readBlockPos()));
    }

    public AutomaticMagicInfuserMenu(int id, Inventory inv, AutomaticMagiculaInfuserBlockEntity entity) {
        super((MenuType) ReiMenus.AUTOMATIC_MAGIC_INFUSER_MENU.get(), id);
