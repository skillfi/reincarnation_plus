...
public class DivineFighterModel extends AnimatedGeoModel<DivineFighterEntity> {
    public ResourceLocation getModelResource(DivineFighterEntity enity) {
        return (ResourceLocation) Gender.getModelLocation(enity);
    }

    public ResourceLocation getTextureResource(DivineFighterEntity ogreEntity) {
        return (ResourceLocation) Skin.getTextureLocation(ogreEntity);
    }


    public ResourceLocation getAnimationResource(DivineFighterEntity ogreEntity) {
        return new ResourceLocation(ReiMod.MODID, "animations/ogre.animation.json");
    }

    public void setCustomAnimations(DivineFighterEntity bear, int instanceId, AnimationEvent customPredicate) {
