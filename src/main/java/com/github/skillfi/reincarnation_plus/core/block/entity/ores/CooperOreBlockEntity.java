...
public class CooperOreBlockEntity extends BlockEntity implements IAnimatable {
    ...
    public CooperOreBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ReiBlockEntities.COOPER_MAGIC_ORE.get(), pPos, pBlockState);
        this.tickCounter = 0;
        this.magicules = 0.0;
        this.id = 2;
    ...
    public MagicOreVariant.OreAge getAge(){
        return MagicOreVariant.OreAge.byId(getBlockState().getValue(CooperMagicOreBlock.AGE));
    }

    public void growth(){
        getBlockState().setValue(CooperMagicOreBlock.AGE, getBlockState().getValue(CooperMagicOreBlock.AGE)+1);
        needUpdate = true;
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, CooperOreBlockEntity pEntity) {
