...
public class OgreModel extends AnimatedGeoModel<OgreEntity> {
    public ResourceLocation getModelResource(OgreEntity enity) {
        return (ResourceLocation) Gender.getModelLocation(enity);
    }

    public ResourceLocation getTextureResource(OgreEntity ogreEntity) {
        return (ResourceLocation) Skin.getTextureLocation(ogreEntity);
    }


    public ResourceLocation getAnimationResource(OgreEntity ogreEntity) {
        return new ResourceLocation(ReiMod.MODID, "animations/ogre.animation.json");
    }

    public void setCustomAnimations(OgreEntity bear, int instanceId, AnimationEvent customPredicate) {
