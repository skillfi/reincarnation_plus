...
public class IronOre2BlockEntity extends BlockEntity {
    @Getter @Setter private double magicules;
    @Getter @Setter private int tickCounter;

    public IronOre2BlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ReiBlockEntities.IRON_MAGIC_ORE_AGE2.get(), pPos, pBlockState);
        this.magicules = 0.0;
        this.tickCounter = 0;
    }
