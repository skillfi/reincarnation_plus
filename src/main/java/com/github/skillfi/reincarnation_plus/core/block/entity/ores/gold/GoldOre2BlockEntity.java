package com.github.skillfi.reincarnation_plus.core.block.entity.ores.gold;
...
public class GoldOre2BlockEntity extends BlockEntity {
    @Getter @Setter private double magicules;
    @Getter @Setter private int tickCounter;

    public GoldOre2BlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ReiBlockEntities.GOLD_MAGIC_ORE_AGE2.get(), pPos, pBlockState);
        this.magicules = 0.0;
        this.tickCounter = 0;
    }
