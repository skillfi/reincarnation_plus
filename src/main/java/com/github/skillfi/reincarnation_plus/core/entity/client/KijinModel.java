...
public class KijinModel extends AnimatedGeoModel<KijinEntity> {
    public ResourceLocation getModelResource(KijinEntity enity) {
        return (ResourceLocation) Gender.getModelLocation(enity);
    }

    public ResourceLocation getTextureResource(KijinEntity ogreEntity) {
        return (ResourceLocation) Skin.getTextureLocation(ogreEntity);
    }


    public ResourceLocation getAnimationResource(KijinEntity ogreEntity) {
        return new ResourceLocation(ReiMod.MODID, "animations/ogre.animation.json");
    }

    public void setCustomAnimations(KijinEntity bear, int instanceId, AnimationEvent customPredicate) {
