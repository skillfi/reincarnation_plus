...
public class CooperOre3BlockEntity extends BlockEntity {
    @Getter @Setter private double magicules;
    @Getter @Setter private int tickCounter;


    public CooperOre3BlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ReiBlockEntities.COOPER_MAGIC_ORE_AGE3.get(), pPos, pBlockState);
        this.magicules = 0.0;
        this.tickCounter = 0;
    }
