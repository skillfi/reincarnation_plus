...
public class AutoInfuserScreen extends AbstractContainerScreen<AutoInfuserMenu> {
    ...
    private void renderFire(PoseStack pPoseStack, int x, int y) {
        if (((AutoInfuserMenu)this.menu).hasFuel()) {
            this.blit(pPoseStack, x + 37, y + 89 - ((AutoInfuserMenu)this.menu).getScaledFuelProgress(), 78, 181 - ((AutoInfuserMenu)this.menu).getScaledFuelProgress(), 13, ((AutoInfuserMenu)this.menu).getScaledFuelProgress());
        }
    }
