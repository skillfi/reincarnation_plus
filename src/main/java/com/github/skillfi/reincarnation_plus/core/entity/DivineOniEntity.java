...
public class DivineOniEntity extends OniEntity implements IAnimatable {
    ...
    private static final ArrayList<ManasSkill> skills = new ArrayList<ManasSkill>();
    private static final ArrayList<ManasSkill> instances = new ArrayList<ManasSkill>();
    private Vec3 previousPosition = Vec3.ZERO;

    static {
        EVOLVING = SynchedEntityData.defineId(DivineOniEntity.class, EntityDataSerializers.INT);
        MISC_ANIMATION = SynchedEntityData.defineId(DivineOniEntity.class, EntityDataSerializers.INT);
        EVOLVE_STATE = SynchedEntityData.defineId(DivineOniEntity.class, EntityDataSerializers.INT);
        CAN_EVOLVE = SynchedEntityData.defineId(DivineOniEntity.class, EntityDataSerializers.BOOLEAN);
    }
    ...
    public static AttributeSupplier setAttributes() {
        return Mob.createMobAttributes().
                ...
                add(Attributes.ATTACK_SPEED, DIVINE_ONI.getRace().getBaseAttackSpeed()).
                add(Attributes.MOVEMENT_SPEED, DIVINE_ONI.getRace().getMovementSpeed()).
                add((Attribute) TensuraAttributeRegistry.MAX_MAGICULE.get(), DIVINE_ONI.getRace().getMaxBaseMagicule()).
                add(Attributes.FOLLOW_RANGE, 16).
                add(TensuraAttributeRegistry.MAX_SPIRITUAL_HEALTH.get(), DIVINE_ONI.getSHP()).
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new SpearTypeAttackGoal(this, 1.0, 20, 20.0F) {
            public boolean canUse() {
                DivineOniEntity ogre = DivineOniEntity.this;
        ...
        this.targetSelector.addGoal(3, (new TensuraHurtByTargetGoal(this, DivineOniEntity.class)).setAlertOthers());
    ...
    public @NotNull AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        DivineOniEntity baby = (DivineOniEntity) ((EntityType<?>) ReiEntities.DIVINE_ONI.get()).create(pLevel);
        if (baby == null) {
            return null;
        } else {
    ...
    private void getGeneFromParents(DivineOniEntity baby, AgeableMob pOtherParent) {
        // Каст батьків до DivineOniEntity
        DivineOniEntity parentOther = (DivineOniEntity) pOtherParent;
    ...
    public boolean canMate(Animal pOtherAnimal) {
        if (pOtherAnimal == this) {
            ...
            return this.isInLove() && pOtherAnimal.isInLove() && ((DivineOniEntity) pOtherAnimal).getMateGender() != this.getMateGender();
        }
    }
    ...
    public void evolving() {
        ...
        RaceHelper.applyBaseAttribute(DivineFighterEntity.setAttributes(), this, true);
