...
public class DivineOniModel extends AnimatedGeoModel<DivineOniEntity> {
    public ResourceLocation getModelResource(DivineOniEntity enity) {
        return (ResourceLocation) Gender.getModelLocation(enity);
    }

    public ResourceLocation getTextureResource(DivineOniEntity ogreEntity) {
        return (ResourceLocation) Skin.getTextureLocation(ogreEntity);
    }


    public ResourceLocation getAnimationResource(DivineOniEntity ogreEntity) {
        return new ResourceLocation(ReiMod.MODID, "animations/ogre.animation.json");
    }

    public void setCustomAnimations(DivineOniEntity bear, int instanceId, AnimationEvent customPredicate) {
