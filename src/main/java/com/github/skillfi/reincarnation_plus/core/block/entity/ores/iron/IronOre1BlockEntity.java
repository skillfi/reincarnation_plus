...
public class IronOre1BlockEntity extends BlockEntity {
    @Getter @Setter private double magicules;
    @Getter @Setter private int tickCounter;

    public IronOre1BlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ReiBlockEntities.IRON_MAGIC_ORE_AGE1.get(), pPos, pBlockState);
        this.magicules = 0.0;
        this.tickCounter = 0;
    }
