...
public class MagicInfusionRecipe extends MagicInfuserRecipe implements Comparable<MagicInfusionRecipe> {
    ...
    @Getter private final int magicules;
    ...
    public MagicInfusionRecipe(ResourceLocation id, ResourceLocation magiculesId, int magicules, Ingredient ingredient, int cookingTime, ItemStack output) {
        this.id = id;
