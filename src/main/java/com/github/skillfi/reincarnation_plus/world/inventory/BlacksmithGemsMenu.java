...
import com.github.skillfi.reincarnation_plus.init.ReincarnationPlusMenus;
...
public class BlacksmithGemsMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BlacksmithGemsMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ReincarnationPlusMenus.BLACKSMITH_GEMS.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 48) {
			...
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("gems_items")));
			}
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 43, 48) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("tools")));
			}
		}));
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 96, 48) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
