...
//		this.addLayer(new OgreArmorLayer<>(this, new ModelOgre<>(context.bakeLayer(ModelOgre.LAYER_LOCATION)), new ModelOgre<>(context.bakeLayer(ModelOgre.LAYER_LOCATION))));
	}
