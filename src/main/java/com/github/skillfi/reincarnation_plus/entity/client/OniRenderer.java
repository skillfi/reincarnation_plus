...
import com.github.skillfi.reincarnation_plus.entity.OniEntity;
...
public class OniRenderer extends ExtendedGeoEntityRenderer<OniEntity> {
    ...
    protected ItemStack getArmorForBone(String boneName, OniEntity kijinEntity) {
        ItemStack var10000;
        switch (boneName) {
            case "LeftBootArmor":
            case "RightBootArmor":
    ...
    protected @Nullable ResourceLocation getTextureForBone(String boneName, OniEntity kijinEntity) {
    ...
    protected @Nullable ItemStack getHeldItemForBone(String boneName, OniEntity currentEntity) {
        ItemStack var10000;
        switch (boneName) {
    ...
    protected @Nullable BlockState getHeldBlockForBone(String s, OniEntity kijinEntity) {
        return null;
    }


    protected void preRenderItem(PoseStack stack, ItemStack item, String s, OniEntity kijinEntity, IBone iBone) {
    ...
    protected void preRenderBlock(PoseStack poseStack, BlockState blockState, String s, OniEntity ogreEntity) {

    }


    protected void postRenderItem(PoseStack poseStack, ItemStack itemStack, String s, OniEntity ogreEntity, IBone iBone) {

    }


    protected void postRenderBlock(PoseStack poseStack, BlockState blockState, String s, OniEntity ogreEntity) {

    }

    public void renderEarly(OniEntity kijin, PoseStack poseStack, float partialTick, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float partialTicks) {
    ...
    protected EquipmentSlot getEquipmentSlotForArmorBone(String boneName, OniEntity currentEntity) {
