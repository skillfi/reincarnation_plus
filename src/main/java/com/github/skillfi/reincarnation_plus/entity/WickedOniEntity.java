...
import com.github.skillfi.reincarnation_plus.entity.client.DivineFighterRenderer;
...
public class WickedOniEntity extends OniEntity implements IAnimatable {
    private static final EntityDataAccessor<Integer> LAUGHING;
    public WickedOniEntity(EntityType<? extends WickedOniEntity> pEntityType, Level pLevel) {
    ...
    public static AttributeSupplier setAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.ATTACK_DAMAGE, WICKED_ONI.getATTACK_DAMAGE())
                .add(Attributes.MAX_HEALTH, WICKED_ONI.getHP())
                .add(Attributes.MOVEMENT_SPEED, 0.15000000596046448)
                .add(Attributes.FOLLOW_RANGE, 64.0)
                .add(Attributes.ARMOR, WICKED_ONI.getArmor())
                .add(Attributes.KNOCKBACK_RESISTANCE, 1.0)
                .add((Attribute) ForgeMod.SWIM_SPEED.get(), 3.0)
                .add((Attribute) TensuraAttributeRegistry.MAX_SPIRITUAL_HEALTH.get(), WICKED_ONI.getSHP())
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new EatingItemGoal(this, (entity) -> {
            ...
            public boolean canUse() {
                return WickedOniEntity.this.getLaughing() > 0 ? false : super.canUse();
            }
        });
        ...
        this.goalSelector.addGoal(5, new BreedGoal(this, 1.2, WickedOniEntity.class));
        ...
        this.targetSelector.addGoal(3, (new TensuraHurtByTargetGoal(this, new Class[]{WickedOniEntity.class})).setAlertOthers(new Class[0]));
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        ...
        if (baby == null) {
            ...
            baby.randomTexture();
            if (this.isNextOni() && ((WickedOniEntity) pOtherParent).isNextOni()) {
                baby.evolve();
            }
    ...
    static {
        LAUGHING = SynchedEntityData.defineId(WickedOniEntity.class, EntityDataSerializers.INT);
    }
